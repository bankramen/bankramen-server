...
import org.example.bankramenserver.domain.auth.dto.KakaoLoginResponse;
...
public class KakaoOAuthController {
    ...
    @Operation(
            ...
            description = "카카오 로그인 페이지로 이동하기 위한 인증 URL을 생성하여 반환합니다."
    )
    @GetMapping("/login")
    public ResponseEntity<KakaoLoginResponse> login() {
        ...
        return ResponseEntity.ok(
                new KakaoLoginResponse(loginUrl)
        );
    }
